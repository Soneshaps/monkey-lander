class LevelBuilderMenu{
  ...
  exit(xmouse,ymouse){
    const distance = Math.sqrt(
      ((xmouse-this.exitX)*(xmouse-this.exitX))+((ymouse-this.exitY)*(ymouse-this.exitY))
    )
  ...
  coconut(xmouse,ymouse){
    const distance = Math.sqrt(
      ((xmouse-this.coconutX)*(xmouse-this.coconutX))+((ymouse-this.coconutY)*(ymouse-this.coconutY))
    )
    if(distance<this.radius){
  ...
  monkey(xmouse,ymouse){
    const distance = Math.sqrt(
      ((xmouse-this.monkeyX)*(xmouse-this.monkeyX))+((ymouse-this.monkeyY)*(ymouse-this.monkeyY))
    )
    if(distance<this.radius){
