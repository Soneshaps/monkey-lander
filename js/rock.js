class Rock{
  ...
  update(ctx){
    ...
    ctx.lineTo(this.position[game.level].x+111,this.position[game.level].y+70)
    ctx.lineTo(this.position[game.level].x+112,this.position[game.level].y+100)
    ctx.lineTo(this.position[game.level].x+107,this.position[game.level].y+112)
    ctx.lineTo(this.position[game.level].x+85,this.position[game.level].y+120)
    ctx.lineTo(this.position[game.level].x+25,this.position[game.level].y+120)
  ...
  rockPoly(){
    var points =[
      ...
      {x:this.position[game.level].x+111,y:this.position[game.level].y+70},
      {x:this.position[game.level].x+112,y:this.position[game.level].y+100},
      {x:this.position[game.level].x+107,y:this.position[game.level].y+112},
      {x:this.position[game.level].x+85,y:this.position[game.level].y+120},
      {x:this.position[game.level].x+25,y:this.position[game.level].y+120},
